...
function GoalItem({ item }) {
    // For "lower is better" goals: pct = value/target (100% = at limit)
    // For "higher is better" goals (reverse): pct = value/target
...
export default function RightPanel({ metrics, iotSystems, onToggle, currentLevel, grid, activeCascade }) {
    ...
    return (
        <div className="w-56 xl:w-64 bg-white border-l border-gray-100 flex flex-col overflow-y-auto shadow-sm">
